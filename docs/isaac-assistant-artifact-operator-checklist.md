...
**1. Confirm the plan tier.** Custom connectors on a Team/Enterprise org can be
added *only* by an Owner. Organization-private artifact sharing requires Team or
Enterprise. A Pro or Max account can publish **publicly only** — which this project
has decided against (feasibility §4).
