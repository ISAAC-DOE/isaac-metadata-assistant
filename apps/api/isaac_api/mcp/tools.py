    ...
    return (
        ...
        Tool(
            ...
            description=(
                ...
                "**EVERY KEY YOU SEND IS EITHER ACTED ON OR REFUSED BY NAME. NOTHING "
                "IS SILENTLY DROPPED.** Three refusals, all `422`, all writing "
                ...
                "Two narrow exceptions, stated because a silent drop is exactly what "
                "you must not have to guess at: a BLANK value (`null` or `\"\"`) is "
        ...
        Tool(
            ...
            description=(
                ...
                "value. A BLOCK-LEVEL confirmation — the `qc:`, `series:` and "
                "`descriptors:` keys written when a scientist confirms a verdict, a "
                "spectrum or a descriptor — carries its support with `value: null`, "
