...
describe('the leave confirmation, and Next / Previous run', () => {
   ...
   * workspaces (Capture, Proposals, Record Fields) keeps it. Both claims are
  ...
  it('the leave-confirmation dialog states BOTH outcomes, so it does not read as a ' +
    ...
    expect(text).toMatch(
      /Switching to this record’s other workspaces — Capture, Proposals, Record Fields — keeps it\./,
    );
  });
